...
export default async function handler(req, res) {
    ...
    try {
        const item = req.body;
        const chatTitle = await getGroqChatCompletion("parafraseie o título, Não coloque todas as inicias das palavras em maiúsculas, apenas a primeira letra da frase. escolha a melhor opção para um title SEO, com no máximo 94 caracteres e me devolva apenas o texto da melhor opção" + item.title);
